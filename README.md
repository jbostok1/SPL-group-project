...
# Logistic Regression
to run put runhaskell LogisticRegression.hs into your terminal

You will be prompted to give data, first will be the temperature you will be comparing against.  All other data will be the data of the day you are comparing against. 
